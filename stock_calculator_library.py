...
class Stock:
    ...
    def __init__(self, directory_path: str, stock_data: str, currency_to: str, progress_callback: Callable[[], None]=None, cache_dir: str=None):
        ...
        for df in dataframes:
            currency=Currency(self.get_ticker_currency(df, stock_data, self.CSV_TICKER_COLUMN), currency_to, df.index.min(), cache_dir=cache_dir)
        ...
        for df in dataframes:
            ...
            computed=self._compute_data(df, self.get_ticker_currency(df, stock_data, self.CSV_TICKER_COLUMN), currency_to, cache_dir)
    ...
    def _compute_data(self, dataframe: pd.DataFrame, currency_from: str, currency_to: str, cache_dir: str=None) -> pd.DataFrame:
        ...
        currency=Currency(currency_from, currency_to, start_date, cache_dir=cache_dir)
